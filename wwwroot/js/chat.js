...
//    userGroups.forEach(function (group) {
//        var recentMessage = group.Group.Messages.sort(function (a, b) {
//            return new Date(b.SentAt) - new Date(a.SentAt);
//        })[0];

//        var groupElement = document.createElement("p");
//        groupElement.textContent = group.OtherParticipant;  // Use the other participant's name
...
//function updateChatGroupList() {
//    // Make an AJAX request to the server to get the updated chat group list
//    fetch('/Chat/GetChatGroups')
//        .then(response => response.json())
//        .then(data => {
//            // Update the chat group list with the new data
//            var chatGroupsContainer = document.getElementById("chatGroupsContainer");
//            chatGroupsContainer.innerHTML = "";
